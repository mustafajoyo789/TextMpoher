    ...
    <div className='container' style={{color: props.mode==='dark'? 'white' : 'black'}}>
        ...
        <div className="accordion" id="accordionExample">
            <div className="accordion-item">
                ...
                <button className="accordion-button" style={{backgroundColor: props.mode==='dark'? '#201e1e' : 'white', 
                ...
                <div className="accordion-body" style={{backgroundColor: props.mode==='dark'? '#201e1e' : 'white', 
            ...
            <div className="accordion-item">
                <h2 className="accordion-header">
                <button className="accordion-button collapsed" style={{backgroundColor: props.mode==='dark'? '#201e1e' : 'white', 
